...
#		method.append('touch')
		...
		method.append('mobile')
	print(f'{m}CATATAN :\n🎀{k}DisarankanTidak Menampilkan Aplikasi\n 🎀DISARANKAN GUNAKAN PASWORD DEPAULT ') 
	print('')
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	cetak(nel('[bold cyan]               SELAMAT MENUNGGU HASIL, SEMOGABERUNTUNG[bold cyan]')) 
	print(f'          {m}H {k}A {h}R {u}A {b}P {u}  ★  {u}S {b}A {u} B{h} A{k} R{m}')
	print('')
